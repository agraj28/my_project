...
<TITLE img src="1.png">WELCOME TO SOLUTIONS .COM</TITLE>
</HEAD>
<BODY>
	...
	<nav>
		<UL>
			...
			<LI style="float: right"><A class="active"
				href="/officialinsitute/src/main/webapp/WEB-INF/views/signup.jsp">Signup</A></LI>
			<LI style="float: right"><A
				href="/officialinsitute/src/main/webapp/WEB-INF/views/login.jsp">Login</A></LI>
		</UL>
	</nav>
